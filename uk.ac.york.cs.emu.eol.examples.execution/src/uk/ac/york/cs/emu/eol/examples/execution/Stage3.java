...
public class Stage3 {
	...
	public static void main(String[] args) throws Exception {
		...
		String line;
		try {
			read = new BufferedReader(new InputStreamReader(Stage3.class.getResource("configurations/stage3.configurations").openStream()));
		...
		for (String config_file : configurations) {
			...
			EolLauncher runner = new EolLauncher(config, EolLauncher.MUTATION_EXECUTION);
