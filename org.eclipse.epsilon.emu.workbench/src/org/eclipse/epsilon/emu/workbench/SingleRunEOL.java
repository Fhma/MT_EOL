...
public class SingleRunEOL {
	...
	// String modelString = SingleRunEOL.class.getResource("resources/ECore2GMF.xmi").getPath();
	// String modelString = SingleRunEOL.class.getResource("resources/EcoreHelper.xmi").getPath();
    ...
    private static IModel createEmfModel(String name, String model, String metamodel, boolean readOnLoad, boolean storeOnDisposal) throws EolModelLoadingException, URISyntaxException {
